...
_snap_positions = {
    ...
    "center bigger": RelativeScreenPos(1 / 16, 1 / 12, 15 / 16, 11 / 12),
    "center same ratio": RelativeScreenPos(1 / 8, 1 / 8, 7 / 8, 7 / 8),
    "center half": RelativeScreenPos(1 / 4, 0, 3 / 4, 1),
    "center two thirds": RelativeScreenPos(1 / 6, 0, 5 / 6, 1),
}

...
symbols = [
    ...
    Symbol(")", ["R paren", "right paren", "ripper"], None),
    ...
    Symbol("{", None, ["brace", "L brace", "left brace", "curly bracket", "left curly bracket", "lack"],),
    Symbol("}", None, ["R brace", "right brace","R curly bracket", "right curly bracket", "rack"]),
    Symbol("<", None, ["angle", "L Angle", "left angle", "less than"]),
    Symbol(">", None, ["rangle", "R angle", "right angle", "greater than"]),
    Symbol("^", None, ["caret"]),
    Symbol("|", None, ["pipe"]),
    Symbol("'", None, ["quote", "apostrophe", "coat"]),
